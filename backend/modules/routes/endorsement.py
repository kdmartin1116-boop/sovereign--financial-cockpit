...
def _process_endorsements(file, bill_data, sovereign_endorsements, PRIVATE_KEY_PEM):
...
def endorse_bill():
    ...
    file, error_response, status_code = _handle_file_upload(request)
    if error_response:
    ...
    try:
        ...
        endorsed_files = _process_endorsements(
            file, bill_data, sovereign_endorsements, PRIVATE_KEY_PEM
        )
